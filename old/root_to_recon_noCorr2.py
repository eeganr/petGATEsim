# This script processes a ROOT file containing PET data and performs a reconstruction listmode EM updates.
# === Code originally developed by Grant Hee-Sung Park. Input file modification by Caio Gould. ===
import numpy as np
import parallelproj
...
# === CONFIG ===
input_root_file = "/scratch/users/eeganr/july21flange/output1.root"
cont_magnitude = 1e-5
num_TOF_bins = 351
TOF_bin_width = 1
sigma_TOF = 31.85
...
nib.save(nib.Nifti1Image(img_np, affine=np.eye(4)), "newflange_norm_test.nii.gz")
# === Code originally developed by Grant Hee-Sung Park. Input file modification by Caio Gould. ===