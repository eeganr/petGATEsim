...
scount, pcount, coin_lor, dw, actuals = randoms.read_file_lm("/scratch/users/eeganr/aug6flange/output1Singles.dat", "/scratch/users/eeganr/flangelm/coins1.lm", '/scratch/users/eeganr/flangelm/delay1.lm', TAU, DELAY, DETECTORS_SIM)
